...
from .views import list_categories, new_category, category_detail,edit_category,delete_category,new_post_listing_for_category,post_detail_for_category,edit_post_for_category,delete_post_for_category
